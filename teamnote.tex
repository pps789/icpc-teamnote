...
\pagestyle{fancy}
\fancyhead[R]{\thepage}
\fancyhead[L]{Seoul National University - Military Reserve Force}
...
\lstinputlisting[style=mycpp]{src/math/fft-avx.cpp}
...
\lstinputlisting[style=myjava]{src/miscellaneous/example.java}
